...
func (s *Phase1FoundationTestSuite) createInventoryBatch(ctx context.Context, pharmacyProductID, branchID, batchNumber string, quantity, unit string, costPerUnit float64) string {
	var id string
	err := s.pool.QueryRow(ctx, `
