...
func (s *InventoryService) List(ctx context.Context, pharmacyID string) ([]models.Medication, error) {
...
func (s *InventoryService) Create(ctx context.Context, med *models.Medication) error {
	return s.repo.Create(ctx, med)
}

// GetByID returns a single medication
// TODO: Implement
func (s *InventoryService) GetByID(ctx context.Context, id string) (*models.Medication, error) {
	return s.repo.GetByID(ctx, id)
}

// Update updates medication details
// TODO: Implement with stock validation
func (s *InventoryService) Update(ctx context.Context, med *models.Medication) error {
...
func (s *InventoryService) GetLowStockItems(ctx context.Context, pharmacyID string) ([]models.Medication, error) {
